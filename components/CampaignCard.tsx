...
export const CampaignCard = ({ index }: { color?: string; index: number }) => {
  ...
  return (
    <Link
      href="/campaigns/12"
      className="flex h-72 w-72 flex-shrink-0 flex-col justify-between rounded-sm border border-black p-4 shadow-cs-3 shadow-green-500 ease-in hover:border-2"
