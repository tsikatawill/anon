  ...
  return (
    <section id="public-campaigns">
      <Container className="py-8 sm:py-16 md:py-32">
        <div className="shadow-cs-2 mx-auto flex max-w-xl flex-col items-center justify-center gap-6 rounded-md border border-black bg-orange-500 bg-opacity-20 p-5 sm:p-8 md:max-w-2xl md:p-10 xl:max-w-3xl">
